...
extension UIFont {
    ...
    class public func interBold(ofSize fontSize: AppTheme.FontSize) -> UIFont {
    ...
    class public func interRegular(ofSize fontSize: AppTheme.FontSize) -> UIFont {
    ...
    class public func interSemiBold(ofSize fontSize: AppTheme.FontSize) -> UIFont {
